...
- **[Cluster Setup](user-guide/cluster-setup.md)** - Agent installation on SLURM clusters
...
See [Installation Guide](getting-started/installation.md) for detailed manual deployment instructions including:
